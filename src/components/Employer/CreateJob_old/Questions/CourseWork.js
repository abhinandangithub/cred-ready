				...
				<ul className="general-questions">
					...
					<li className="general-question">
						...
						<ul className="level_2">
							<li className="general-question border">
								<h2 className="question">
									What was the final year you took Biology I ?
								</h2>
								<div className="options">
									<input
							...
							<li className="general-question border">
								<h2 className="question">
									What was the final year you took Geometry ?
								</h2>
								<div className="options">
									<input
										className="fancy-toggle blue  radio"
					...
					<li className="general-question">
						...
						<ul className="level_3">
							...
							<li className="general-question border">
								<h2 className="question">
									What was the final year you took French?
								</h2>
								<div className="options">
									<input
										className="fancy-toggle blue  radio"
							...
							<li className="general-question border">
								<h2 className="question">
									What was the final year you took German?
								</h2>
								<div className="options">
									<input
										className="fancy-toggle blue  radio"
