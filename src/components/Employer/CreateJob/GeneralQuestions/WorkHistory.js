...
function WorkHistory({ calHeight }) {
				...
				<ul className="general-questions">
					<li className="general-question">
						...
						<div className="options slider">
							<InputRange minValue={0} maxValue={15} value={value1} onChange={(value) => setValue1(value)} disabled />
						</div>
						<ul className="level_2">
							<li className="general-question border">
								<h2 className="question">How long were you in your most recent job?</h2>
							...
							<li className="general-question border">
								...
								<div className="options">
									...
									<input className="fancy-toggle blue radio" name="cnaBefore" type="radio" id="cnaBeforeNo" disabled />
